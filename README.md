...
<br>
<p align="center">
<img  width=60% height=auto src="./Media_Assets/DEBIX_R3576_01_1.png" alt="DEBIX_R3576_01_1">
</p>
...
|**I/O Interfaces**|
| USB             | 2 x USB 3.0 Host with double layer Type-A <br> 1 x USB 2.0 PWR with Type-C for DC 5V power input <br> 1 x USB 3.0 OTG + DP DISPLAY supports MST with Type-C
| M.2             | 1 x PCIe, M.2 M-KEY 2242 (B-KEY optional)                               |
| 40-Pin Dual-Row Header | 1\) Default: 3 x UART, 2 x SPI, 2 x I2C, 2 x CAN, 6 x GPIO, refer to DEBIX website "DEBIX R3576-01 GPIO Pin Multiplexing Function List", which can beconfigured to I2S, PWM, SPDIF, GPIO, etc. via software <br> 2\) 5V power supply, system reset, ON/OFF     |
...
| Key             | 1 x MASKROM key <br> 1 x ON/OFF key <br> 1 x Reset key                  |
|**Power Supply**|
...
## I/O Interfaces:
<p align="center">
<img src="./Media_Assets/DEBIX_R3576_01_3.png" alt="DEBIX_R3576_01_3" width=90% height=auto>
<img src="./Media_Assets/DEBIX_R3576_01_4.png" alt="DEBIX_R3576_01_4" width=90% height=auto>
</p>
